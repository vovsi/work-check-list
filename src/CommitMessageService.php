...
PROMPT;
    ...
    public function generate(string $taskId, string $description, string $taskLink): string
    {
        ...
        $message = $this->llmClient->chat(self::SYSTEM_PROMPT, $input);

        // Нейронка часто игнорирует текстовое требование про "generated by" — дописываем сами, если не пришло
        $generatedByLine = "Generated by: {$this->modelName}";
        if (!str_contains($message, $generatedByLine)) {
