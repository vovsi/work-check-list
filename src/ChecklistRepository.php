...
final class ChecklistRepository
{
     ...
     * «Начать заново») принудительно отмечаются выполненными, а не обнуляются — это
     ...
     * «Начать заново» — см. resetChecklist().
     */
    ...
    /**
     * Сбрасывает чек-лист (кнопка «Начать заново»). По эффекту полностью идентично
